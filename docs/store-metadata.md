...
— Frase diaria personalizada con IA
— Explicación de por qué esa frase es para ti hoy
— Contexto planetario del momento
— Historial de frases y favoritos
— Carta natal en visualización SVG
— Notificación diaria a la hora que elijas
— Sin anuncios
...
### Keywords (100 chars max, separados por comas)
```
astrología,eneagrama,carta natal,frase diaria,autoconocimiento,horóscopo,numerología,meditación
```
...
### Support URL
```
https://hianadee.github.io/enea/privacy-policy.html
```
...
### Age Rating
```
17+  (razón: temas de filosofía y espiritualidad)
```
...
✦ Contexto planetario del momento
✦ Historial de frases y favoritos
✦ Carta natal en visualización gráfica
✦ Notificación diaria personalizable
✦ Sin anuncios
...
### Tags (Google Play)
```
astrología, eneagrama, autoconocimiento, carta natal, meditación, bienestar
```

### Content Rating
```
Everyone (sin contenido maduro)
```
